...
import "github.com/jhannah/jira/jiracli"
...
func RegisterAllCommands() {
	...
	jiracli.RegisterCommand(jiracli.CommandRegistry{Command: "cr", Entry: CmdTransitionRegistry("Code Review")})
	jiracli.RegisterCommand(jiracli.CommandRegistry{Command: "waiting", Entry: CmdTransitionRegistry("Awaiting Acceptance")})
	jiracli.RegisterCommand(jiracli.CommandRegistry{Command: "ready", Entry: CmdTransitionRegistry("Ready for Deployment")})
	jiracli.RegisterCommand(jiracli.CommandRegistry{Command: "closed", Entry: CmdTransitionRegistry("Closed")})
